...
<div className="flex flex-col gap-2 p-5 mt-50  text-center">
  <h1 className="text-6xl font-bold">Discover Your Next Favorite Movie</h1>
  <p className="text-gray-600 text-xl">Search, explore, and save the best movies from around the world.</p>
